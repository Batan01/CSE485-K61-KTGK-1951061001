...
<body>
    ...
    <main>
    <div class="container">
        <h5 class="text-center text-primary mt-5">Hệ thống quản lý đại học</h5>
        <div>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th scope="col">Số tiết lí thuyết</th>
            ...
            <tbody>
                ...
                <?php
                    ...
                    $conn = mysqli_connect('localhost','root','','db_monhoc');
                    if(!$conn){
                        die("Kết nối thất bại. Vui lòng kiểm tra lại các thông tin máy chủ");
                    }
                    // Bước 02: Thực hiện truy vấn
                    $sql = "SELECT * FROM db_monhoc";
                ...
                ?>
                            <tr>
                                ...
                                <td><a href="delete_employee.php?id=<?php echo $row['mamh']; ?>"><i class="bi bi-trash"></i></a></td>
                            </tr>
                <?php
                        }
                    }
